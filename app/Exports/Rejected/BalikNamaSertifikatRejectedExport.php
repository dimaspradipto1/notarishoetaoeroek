...
namespace App\Exports\Rejected;
...
class BalikNamaSertifikatRejectedExport implements FromCollection, WithHeadings
{
    /**
    ...
    */
    ...
    {
        return BalikNamaSertifikat::query()->where('status', 'Rejected')->get()->map(function ($data, $index) {
            return [
                'no' => $index + 1,
