...
class BalikNamaSertifikatExport implements FromCollection, WithHeadings
{
    /**
    ...
    */
    ...
    {
        return BalikNamaSertifikat::query()->where('status', 'PENDING')->get()->map(function ($data, $index) {
            return [
                'no' => $index + 1,
