...
<main id="main" class="main">
  ...
  <div class="pagetitle">
    <h1>Form Data Lacak Jual Beli Tanah dan Bangunan</h1>
    <nav>
      <ol class="breadcrumb">
      ...
      <div class="col-lg-8">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <form action="{{ route('lacak-tanah.update', $lacak_tanah->id) }}" method="POST">
              @csrf
              @method('PUT')
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <select name="tanahs_id" id="select2" class="form-control">
                    ...
                    <option value="{{ $item->id }}" {{ $item->id == $lacak_tanah->tanahs_id ? 'selected' : '' }}>{{ $item->nama_pemilik }}</option>
                    @endforeach
                  </select>
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <select name="users_id" id="users_id" class="form-control">
                    ...
                    <option value="{{ $user->id }}" {{ $user->id == $lacak_tanah->users_id ? 'selected' : '' }}>{{ $user->name }}</option>
                    @endforeach
                  </select>
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                 <textarea name="keterangan">{{ $lacak_tanah->keterangan }}</textarea>
                </div>
              </div>
