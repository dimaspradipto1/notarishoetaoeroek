          ...
          <div class="card-body">
            ...
            <form action="{{ route('sertifikat.update', $sertifikat->id) }}" method="POST">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <select name="status" class="form-control select2">
                    <option value="{{ $sertifikat->status }}"> {{ $sertifikat->status }} </option>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <textarea name="keterangan" class="form-control" id="alamat" cols="30" rows="3">{{ $sertifikat->keterangan }}</textarea>
                </div>
              </div>
