  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">EDIT DATA JUAL BELI TANAH DAN BANGUNAN</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
          ...
          <div class="card-body">
            ...
            <form action="{{ route('tanah.update', $tanah->id) }}" method="POST">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <select name="status" class="form-control select2">
                    <option value="{{ $tanah->status }}"> {{ $tanah->status }} </option>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <textarea name="keterangan" class="form-control" id="alamat" cols="30" rows="3">{{ $tanah->keterangan }}</textarea>
                </div>
              </div>
